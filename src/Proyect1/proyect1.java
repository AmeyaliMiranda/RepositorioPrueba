package Proyect1; // nombre de la empresa en la que trabajemos

/*
class indica que es una clase
public indica visibilidad
 */
public class proyect1 {
    ...
    *String [] args -> array de argumentos podria recibir datos por la entrada
    estandar.
    */

    /**
     * Esto es una documentación del código
     * @param args
     */

    /*
    Imprime a través de terminal
     */
